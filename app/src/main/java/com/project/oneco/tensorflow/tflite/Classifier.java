...
package com.project.oneco.tensorflow.tflite;
...
public abstract class Classifier {
    ...
    protected Classifier(Activity activity, Device device, int numThreads) throws IOException {
        ...
        Log.d("jay", "Created a Tensorflow Lite Image Classifier.");
    }
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap, int sensorOrientation) {
        ...
        Trace.endSection();
        Log.v("jay", "Timecost to load the image: " + (endTimeForLoadImage - startTimeForLoadImage));
        ...
        Trace.endSection();
        Log.v("jay", "imecost to run model inference: " + (endTimeForReference - startTimeForReference));

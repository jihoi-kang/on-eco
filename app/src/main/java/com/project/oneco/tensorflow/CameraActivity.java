...
import com.project.oneco.tensorflow.env.ImageUtils;
...
//    recognition2ValueTextView = findViewById(R.id.detected_item2_value);
    ...
    */
     ...
     */
        ...
        device = Classifier.Device.valueOf("CPU");
    /*
    ...
    protected void fillBytes(final Image.Plane[] planes, final byte[][] yuvBytes) { // plane : 이미지 데이터의 단일 색상 면(?), 이미지가 종료되면 여기 접근할 수 없다.
